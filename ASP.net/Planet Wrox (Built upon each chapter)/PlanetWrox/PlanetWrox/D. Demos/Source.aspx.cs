...
namespace PlanetWrox
{
    public partial class Source : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Server.Transfer("Target.aspx?Test=SomeValue");//With server side transfers, you must specify the .aspx extension. This method redirect to a new page on the server side, letting you hide quesry strings from the user.
        }
    }
}